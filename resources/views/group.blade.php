                ...
                <div class="chat-header">
                    ...
                    <div class="media chat-name align-items-center text-truncate">
                        <div class="avatar bg-success text-light d-none d-sm-inline-block mr-3">
                            <span>
                                <img class="injectable"src="{{ asset('/group_thumb') }}/{{ $group_details->group_thumb }}" alt="">
                            </span>
                        </div>
                        ...
                        <li class="nav-item list-inline-item d-none d-sm-block mr-0">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" style="">
                                    ...
                                    <a class="dropdown-item align-items-center d-flex text-danger" href="/leave_group/{{$id}}">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                <div class="file_choosen_trigger">
                                                    <a class="dropdown-item" href="#">
                                                        ...
                                                        <span><input type="file" class="hide_file" name="files"
                                                                onchange="readURL(this);" id="image" style="display: none;">
                                                            Gallery</span>
                                                    </a>
                                                </div>
                ...
                <div class="d-flex h-100 flex-column">
                    ...
                    <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="avatar bg-success text-light avatar-xl mx-5 mb-3">
                                <span>
                                    <img class="injectable hw-50"
                                        src="{{ asset('/group_thumb') }}/{{ $group_details->group_thumb ?? 'avatar.png'}}" alt="">
                                </span>
                            </div>
                        ...
                        <div class="chat-info-group">
                            <a class="chat-info-group-header" data-toggle="collapse" href="#participants-list" role="button"
                                aria-expanded="true" aria-controls="participants-list">
                                            ...
                                            <li class="list-group-item">
                                                <div class="media align-items-center">
                                                    <div class="avatar mr-2">
                                                        <img src="{{asset('/assets/media/avatar')}}/{{$member_details->avatar ?? 'avatar.png'}}" alt="">
                                                    </div>
